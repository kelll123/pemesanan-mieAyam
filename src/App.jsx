...
function App() {
  ...
  const [view, setView] = useState("home"); // Navigasi: "home", "about", "documentation", "admin"
  ...
  // 4. Logika penambahan item ke dalam keranjang belanja
    ...
    <div className="app-container fade-in">
      ...
      {view === "home" && (
        <>
          ...
          {/* SECTION TESTIMONI / KOMENTAR PELANGGAN */}
          <section className="testimonials-section">
            <div className="section-title">
              <h2>Apa Kata Pelanggan Kami?</h2>
              <p className="section-subtitle">Komentar jujur dari mereka yang sudah merasakan kelezatan Niki Eco 602</p>
            </div>

            <div className="testimonials-grid">
              <div className="testimonial-card">
                <div className="avatar avatar-green">BS</div>
                <h3>Budi Santoso</h3>
                <p className="comment">"Makanan nya enak banget, rasanya konsisten dari dulu!"</p>
              </div>

              <div className="testimonial-card">
                <div className="avatar avatar-blue">SA</div>
                <h3>Siti Aminah</h3>
                <p className="comment">"Pelayanan cepat dan higienis. Mie-nya kerasa banget kalau buatan sendiri."</p>
              </div>

              <div className="testimonial-card">
                <div className="avatar avatar-orange">AW</div>
                <h3>Andi Wijaya</h3>
                <p className="comment">"Harga terjangkau untuk kualitas mi homemade sekelas bintang 5."</p>
              </div>

              <div className="testimonial-card">
                <div className="avatar avatar-pink">RR</div>
                <h3>Rina Rose</h3>
                <p className="comment">"Suka banget sama bumbu kuahnya, gurih alami tanpa bikin seret!"</p>
              </div>

              <div className="testimonial-card">
                <div className="avatar avatar-purple">EP</div>
                <h3>Eko Prasetyo</h3>
                <p className="comment">"Pesan via web tinggal kirim WhatsApp, praktis banget gapake antre."</p>
              </div>
            </div>

            {/* BUTTON BARU: CEK SELENGKAPNYA */}
            <div className="view-more-container">
              <button className="view-more-btn" onClick={() => setView("documentation")}>
                Cek Selengkapnya & Docs →
              </button>
            </div>
          </section>
        </>
      ...
      {/* TAMPILAN HALAMAN DOKUMENTASI & GALERI MODERN (DOCUMENTATION VIEW) */}
      {view === "documentation" && (
        <section className="docs-section fade-in">
          ...
          <div className="docs-layout">
            {/* Sidebar Menu ala Web Dokumentasi Resmi */}
            <aside className="docs-sidebar">
              <h4>Dokumentasi</h4>
              <ul>
                <li className="active">🚀 Ringkasan Sistem</li>
                <li>🍜 Standar Bahan Baku</li>
                <li>🧼 Protokol Higienitas</li>
                <li>📸 Galeri Foto Produk</li>
                <li>📦 Layanan Catering</li>
              </ul>
            </aside>

            {/* Konten Utama Dokumen & Galeri */}
              ...
              <div className="docs-card animate-card">
                ...
                <div className="docs-meta-grid">
                  <div className="meta-box">
                    <h5>100% Homemade</h5>
                    <p>Adonan mi diolah segar setiap pagi tanpa bahan pengawet komersial.</p>
                  </div>
                  <div className="meta-box">
                    <h5>Sertifikasi Halal</h5>
                    <p>Menjamin seluruh bahan baku dan proses aman dikonsumsi.</p>
                  </div>
                </div>
              </div>

              {/* Grid Galeri Modern Showcase */}
              <h3 className="gallery-title">📸 Galeri Visual Produk & Kegiatan</h3>
              <div className="docs-gallery-grid">
                <div className="gallery-item">
                  <img src="https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=500" alt="Proses Pembuatan Mi" />
                  <div className="gallery-overlay">
                    <h4>Produksi Mi Segar</h4>
                    <p>Pengolahan higienis harian</p>
                  </div>
                </div>
                <div className="gallery-item">
                  <img src="https://images.unsplash.com/photo-1552611052-33e04de081de?w=500" alt="Dapur Bersih" />
                  <div className="gallery-overlay">
                    <h4>Dapur Utama</h4>
                ...
                <div className="gallery-item">
                  <img src="https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500" alt="Penyajian Menu" />
                  <div className="gallery-overlay">
                    <h4>Sajian Mie Pangsit</h4>
                    <p>Porsi hangat siap saji</p>
                  </div>
                </div>
                <div className="gallery-item">
                  <img src="https://images.unsplash.com/photo-1600891964599-f61ba0e24092?w=500" alt="Layanan Event" />
                  <div className="gallery-overlay">
                    <h4>Dokumentasi Catering</h4>
                    <p>Pelayanan pesta & gathering</p>
                  </div>
                </div>
              </div>
            </main>
